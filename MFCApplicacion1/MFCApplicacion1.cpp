...
// MFCApplicacion1.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CMFCApplicacion1App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CMFCApplicacion1App

CMFCApplicacion1App::CMFCApplicacion1App()
{
...
// Único objeto CMFCApplicacion1App

CMFCApplicacion1App theApp;


// Inicialización de CMFCApplicacion1App

BOOL CMFCApplicacion1App::InitInstance()
{
