...
// MFCApplicacion.cpp: define los comportamientos de las clases para la aplicación.
//
...
BEGIN_MESSAGE_MAP(CMFCApplicacionApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construcción de CMFCApplicacionApp

CMFCApplicacionApp::CMFCApplicacionApp()
{
...
// Único objeto CMFCApplicacionApp

CMFCApplicacionApp theApp;


// Inicialización de CMFCApplicacionApp

BOOL CMFCApplicacionApp::InitInstance()
{
