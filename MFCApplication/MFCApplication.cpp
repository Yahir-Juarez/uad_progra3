...
// MFCApplication.cpp: define los comportamientos de las clases para la aplicación.
//
...
// Construcción de CMFCApplicationApp
...
// Único objeto CMFCApplicationApp

CMFCApplicationApp theApp;


// Inicialización de CMFCApplicationApp
